...
KEY `user` (`user`),
CONSTRAINT `{$prefix}businesses_ibfk_2` FOREIGN KEY (`user`) REFERENCES `{$prefix}users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CONSTRAINT `{$prefix}customers_ibfk_2` FOREIGN KEY (`business`) REFERENCES `{$prefix}businesses` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
